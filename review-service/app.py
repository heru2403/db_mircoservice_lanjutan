...
# determine mongo uri based on the environment
...
# determine product service uri based on the environment
...
# helper to format ObjectId as string
...
# Menjalankan aplikasi Flask pada port 3004
